...
import { Database, Server, Layout, RefreshCw, ShieldCheck, Container } from 'lucide-react';
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '24px', marginBottom: '48px' }}>
        ...
        <div className="glass-panel" style={{ padding: '28px' }}>
          ...
          <div style={{ borderTop: '1px solid var(--card-border)', paddingTop: '16px', fontSize: '0.85rem', color: 'var(--text-dim)' }}>
            <strong>Container:</strong> regz-frontend (Porta 80)
          </div>
        </div>
        ...
        <div className="glass-panel" style={{ padding: '28px' }}>
          ...
          <div style={{ borderTop: '1px solid var(--card-border)', paddingTop: '16px', fontSize: '0.85rem', color: 'var(--text-dim)' }}>
            <strong>Uptime:</strong> {backendHealth ? `${Math.floor(backendHealth.uptime)}s` : 'Desconectado'} | <strong>Porta:</strong> 4000
          </div>
        </div>
        ...
        <div className="glass-panel" style={{ padding: '28px' }}>
          ...
          <p style={{ color: 'var(--text-muted)', fontSize: '0.9rem', marginBottom: '20px' }}>
            Imagem <code style={{ color: '#38bdf8' }}>postgres:15-alpine</code> com volume de dados persistente.
          </p>
          <div style={{ borderTop: '1px solid var(--card-border)', paddingTop: '16px', fontSize: '0.85rem', color: 'var(--text-dim)' }}>
            <strong>Database:</strong> regz_db | <strong>Porta:</strong> 5432
          </div>
        </div>
      </div>
