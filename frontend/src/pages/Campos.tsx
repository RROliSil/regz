...
export const Campos: React.FC = () => {
  ...
  const getTipoBadge = (tipo: string) => {
    switch (tipo) {
      ...
      case 'texto':
        return (
          <span style={{ background: 'rgba(56, 189, 248, 0.15)', color: '#5e5eee', padding: '3px 8px', borderRadius: '6px', fontSize: '0.78rem', display: 'inline-flex', alignItems: 'center', gap: '4px', fontWeight: 600 }}>
            <Type size={12} /> Texto
          </span>
        );
      case 'selecao':
    ...
    <div className="page-content campos-page">
      ...
      <div className="campos-cards-grid">
        ...
        <div className="glass-panel" style={{ padding: '24px', display: 'flex', flexDirection: 'column', height: '100%' }}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '16px', borderBottom: '1px solid var(--card-border)', paddingBottom: '12px' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
              <div style={{ padding: '8px', borderRadius: '10px', background: 'rgba(56, 189, 248, 0.15)', color: '#5e5eee' }}>
                <Type size={20} />
              </div>
