...
export const SuperAdmin: React.FC = () => {
  ...
  return (
    <div className="superadmin-container" data-theme="padrao" style={{ minHeight: '100vh', background: '#020617', color: '#f8fafc', padding: '24px 36px' }}>
      ...
      <header className="superadmin-header" style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
          ...
          <div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
              <h1 className="superadmin-title" style={{ margin: 0, fontSize: '1.5rem', fontWeight: 800, color: '#ffffff' }}>
            ...
            <p className="superadmin-subtitle" style={{ margin: '4px 0 0 0', fontSize: '0.85rem', color: '#94a3b8' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
          <div style={{ textAlign: 'right', fontSize: '0.85rem' }}>
            <span style={{ display: 'block', fontWeight: 700, color: '#ffffff' }}>{usuario?.nome || 'Administrador Regz'}</span>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '16px' }}>
          <div className="superadmin-stat-card" style={{ background: '#0f172a', border: '1px solid rgba(255, 255, 255, 0.08)', padding: '20px', borderRadius: '16px', display: 'flex', alignItems: 'center', gap: '16px' }}>
            ...
            <div>
              ...
              <h3 style={{ margin: '4px 0 0 0', fontSize: '1.7rem', fontWeight: 800, color: '#ffffff' }}>{empresas.length}</h3>
            </div>
          </div>
          ...
          <div className="superadmin-stat-card" style={{ background: '#0f172a', border: '1px solid rgba(255, 255, 255, 0.08)', padding: '20px', borderRadius: '16px', display: 'flex', alignItems: 'center', gap: '16px' }}>
            ...
            <div>
              ...
              <h3 style={{ margin: '4px 0 0 0', fontSize: '1.7rem', fontWeight: 800, color: '#ffffff' }}>
        ...
        {/* Action Header */}
        <div className="superadmin-section-header" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', background: '#0f172a', border: '1px solid rgba(255, 255, 255, 0.08)', padding: '18px 24px', borderRadius: '16px' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
            <Building2 size={22} color="#818cf8" />
            <div>
              <h3 style={{ margin: 0, fontSize: '1.15rem', fontWeight: 700, color: '#ffffff' }}>Gestão de Empresas Clientes ({empresas.length})</h3>
      ...
      {selectedEmpresaLicencas && (
        <div className="modal-backdrop">
          <div className="modal-content superadmin-modal-card" style={{ maxWidth: '1400px', width: '96vw', maxHeight: '92vh', background: '#0f172a', border: '1px solid rgba(56, 189, 248, 0.4)', display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
            ...
            <div className="custom-scrollbar" style={{ padding: '20px 24px', display: 'flex', flexDirection: 'column', gap: '16px', overflowY: 'auto', flex: 1 }}>
              <div className="superadmin-modal-banner" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', background: 'rgba(30, 41, 59, 0.6)', padding: '14px 20px', borderRadius: '14px', border: '1px solid rgba(255, 255, 255, 0.08)' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                  <Shield size={20} color="#38bdf8" />
                  <span className="superadmin-modal-banner-title" style={{ fontSize: '0.95rem', color: '#f8fafc', fontWeight: 700 }}>
              ...
              {loadingEmpresaLicencas ? (
                ...
                <div className="superadmin-empty-box" style={{ textAlign: 'center', padding: '40px', background: 'rgba(30, 41, 59, 0.5)', borderRadius: '12px', color: '#94a3b8' }}>
                  Nenhuma chave emitida para esta empresa. Clique em "+ Emitir Nova Chave de Licença Master".
                </div>
              ) : (
                <div className="superadmin-table-container" style={{ overflowX: 'auto', background: 'rgba(15, 23, 42, 0.6)', borderRadius: '12px', border: '1px solid rgba(255, 255, 255, 0.08)' }}>
      ...
      {selectedEmpresaUsuarios && (
        <div className="modal-backdrop">
          <div className="modal-content superadmin-modal-card" style={{ maxWidth: '1200px', width: '94vw', maxHeight: '90vh', background: '#0f172a', border: '1px solid rgba(99, 102, 241, 0.4)', display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
            ...
            <div className="custom-scrollbar" style={{ padding: '20px 24px', display: 'flex', flexDirection: 'column', gap: '16px', overflowY: 'auto', flex: 1 }}>
              ...
              {loadingEmpresaUsuarios ? (
                ...
                <div className="superadmin-empty-box" style={{ textAlign: 'center', padding: '30px', background: 'rgba(30, 41, 59, 0.5)', borderRadius: '10px', color: '#94a3b8' }}>
      ...
      {modalEmpresaOpen && (
        <div className="modal-backdrop" style={{ zIndex: 2000 }}>
          <div className="modal-content superadmin-modal-card" style={{ maxWidth: '720px', width: '90%', background: '#0f172a', border: '1px solid rgba(99, 102, 241, 0.3)' }}>
            ...
            <form onSubmit={handleSaveEmpresa} className="modal-form" autoComplete="off" data-lpignore="true" style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
              ...
              <div className="superadmin-modal-innerbox" style={{ background: 'rgba(30, 41, 59, 0.8)', padding: '14px 16px', borderRadius: '12px', border: '1px solid rgba(255, 255, 255, 0.1)' }}>
      ...
      {modalLicencaOpen && (
        <div className="modal-backdrop" style={{ zIndex: 2000 }}>
          <div className="modal-content superadmin-modal-card" style={{ maxWidth: '520px', background: '#0f172a', border: '1px solid rgba(99, 102, 241, 0.3)' }}>
            <div className="modal-header">
              <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
            ...
            <form onSubmit={handleGerarNovaLicenca} className="modal-form" style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
              <div className="form-group">
                ...
                <select
                  value={newLicencaEmpresaId}
                  onChange={(e) => setNewLicencaEmpresaId(e.target.value)}
                  style={{ background: 'rgba(30, 41, 59, 0.8)', color: '#ffffff', border: '1px solid rgba(255, 255, 255, 0.1)', padding: '10px 14px', borderRadius: '8px' }}
                >
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '14px' }}>
                ...
                <div className="form-group">
                  ...
                  <select
                    ...
                    onChange={(e) => setNewLicencaValidade(Number(e.target.value))}
                    style={{ background: 'rgba(30, 41, 59, 0.8)', color: '#ffffff', border: '1px solid rgba(255, 255, 255, 0.1)', padding: '10px 14px', borderRadius: '8px' }}
                  >
      ...
      {modalRenovarOpen && selectedLicencaRenovar && (
        <div className="modal-backdrop" style={{ zIndex: 2000 }}>
          <div className="modal-content superadmin-modal-card renovar-modal-card" style={{ maxWidth: '520px', background: '#0f172a', border: '1px solid rgba(99, 102, 241, 0.3)' }}>
            <div className="modal-header">
              <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
            ...
            <div style={{ padding: '16px 0', display: 'flex', flexDirection: 'column', gap: '16px' }}>
              <div className="superadmin-modal-innerbox" style={{ background: 'rgba(30, 41, 59, 0.8)', padding: '12px 16px', borderRadius: '10px', border: '1px solid rgba(255, 255, 255, 0.1)' }}>
      ...
      {empresaToDelete && (
        <div className="modal-backdrop" style={{ zIndex: 2000 }}>
          <div className="modal-content superadmin-modal-card" style={{ maxWidth: '520px', background: '#0f172a', border: '1px solid rgba(239, 68, 68, 0.4)' }}>
            <div className="modal-header">
              <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
      ...
      {modalCreateUserOpen && selectedEmpresaUsuarios && (
        <div className="modal-backdrop" style={{ zIndex: 2000 }}>
          <div className="modal-content superadmin-modal-card" style={{ maxWidth: '580px', background: '#0f172a', border: '1px solid rgba(99, 102, 241, 0.4)', borderRadius: '16px' }}>
            <div className="modal-header">
              <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
